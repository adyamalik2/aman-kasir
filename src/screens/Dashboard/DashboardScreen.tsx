      ...
      <div className="rounded-2xl bg-primary dark:bg-dark-card border border-primary-900 dark:border-dark-border p-5 shadow-sm">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-xs font-semibold text-primary-200 dark:text-dark-muted uppercase tracking-wide">
              Omzet Hari Ini
            </p>
            {summaryLoaded ? (
            ...
            {summaryLoaded ? (
              <p className="mt-1 text-xs text-primary-200 dark:text-dark-muted">
